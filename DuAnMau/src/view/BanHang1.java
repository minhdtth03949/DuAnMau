...
public class BanHang extends javax.swing.JFrame {
    ...
    int maSP, rowIndexSP, maCTSP, maHD, rowindexHD, rowindexCTSP, maCTHD;
    float donGia;
    ...
    public void LoadSanPham() throws ClassNotFoundException, SQLException{
        ...
        String[] columns = {"Mã", "Tên", "Loại", "Giá"};
    ...
    public void LoadHoaDon() throws ClassNotFoundException, SQLException{
        ...
        model.setRowCount(0);
        model.setColumnCount(4);
        String[] columns = {"Mã", "NgàyLap", "Tên Khách Hàng", "Tổng Tiền"};
        model.setColumnIdentifiers(columns);
    ...
    public void LoadChiTietHoaDon(int maHD) throws ClassNotFoundException, SQLException{
        ...
        String[] columns = {"Mã CTHD", "Mã HD", "Mã CTSP" , "Tên SP", "Màu sắc", "Kích Cỡ", "Số lượng", "Đơn giá"};
        model.setColumnIdentifiers(columns);
        for(String[] obj : qlbh.getChiTietHoaDon(maHD)){
            model.addRow(new Object[]{
    ...
    public void LoadChiTietSP(int maSP) throws ClassNotFoundException, SQLException{
        ...
        String[] columns = {"Mã", "MaSP", "Màu Sắc", "Kích Thước", "Số Lượng"};
        model.setColumnIdentifiers(columns);
    ...
    private void UpdateTongTien(int maHD) throws ClassNotFoundException, SQLException{
        float tongtien = 0;
        for (ChiTietHoaDon ct : qlbh.getAllChiTietHoaDon(maHD)){
            tongtien += ct.getSoLuong() * ct.getDonGia();
        }
        qlbh.UpdateHoaDon(tongtien, maHD);
    }
